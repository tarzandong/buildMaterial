...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"中山建材","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var store = new _vuex.default.Store({
  ...
  getters: {
    ...
    mpMainHeight: function mpMainHeight(state) {
      return state.fullHeight - state.safeTop - 95; //95是顶部和底部导航栏的高度和
    } },

  mutations: {
    login: function login(state, body) {
      state.hasLogin = true;
      state.userInfo = body;
      body.verifyCode = '';
    ...
    changeNick: function changeNick(state, name) {
    ...
    setCL: function setCL(state, list) {
      state.categoryList = list;
    },
    setBL: function setBL(state, list) {
      state.brandList = list;
    },
    setLIC: function setLIC(state, list) {
      state.backEnd.listInCar = list;
    },
    setLIO: function setLIO(state, list) {
      state.backEnd.listInOrder = list;
    },
    setLoading: function setLoading(state, b) {
      state.loading = b;
    },

    setPlatForm: function setPlatForm(state, s) {
      state.platform = s;
    },
    setFW: function setFW(state, fw) {
      state.fullWidth = fw;
    },
    setFH: function setFH(state, fh) {
      state.fullHeight = fh;
    },
    setST: function setST(state, st) {
      state.safeTop = st;
    },
    getWarnFun: function getWarnFun(state, fun) {
      state.showWarn = fun;
    },
    setWarn: function setWarn(state, m) {
      state.warnMessage = m;
    },
    setPopShow: function setPopShow(state, b) {
      state.popupShow = b;
    },
    setTBC: function setTBC(state, i) {
      state.tabBarCur = i;
    },

    resetCar: function resetCar(state, list) {
      state.backEnd.listInCar = list;
    },
    pushToCar: function pushToCar(state, item) {
      state.backEnd.listInCar.push(item);
    },
    pushToOrder: function pushToOrder(state, list) {
      if (list instanceof Array)
      state.backEnd.listInOrder = [].concat(_toConsumableArray(state.backEnd.listInOrder), _toConsumableArray(list));else

      state.backEnd.listInOrder.push(list);
    } },

  actions: {
    warn: function warn(context, message) {
      var d = 3000;
...
/***/ 110:
/*!*****************************************************!*\
  !*** F:/HDemo/BM/components/ay-qrcode/qrcode_wx.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 111:
/*!********************************************************!*\
  !*** F:/HDemo/BM/components/ay-qrcode/weapp-qrcode.js ***!
  \********************************************************/
/*! no static exports found */
...
/***/ 13:
/*!****************************************!*\
  !*** F:/HDemo/BM/mixin/showMessage.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!****************************************!*\
  !*** F:/HDemo/BM/network/myrequest.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = myRequest;var _index = _interopRequireDefault(__webpack_require__(/*! ../store/index.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}


var baseUrl = _index.default.state.baseUrl;


function myRequest(api, body) {var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'POST';var url = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : baseUrl;
  var phone = this.$store.state.userInfo.userPhone ? this.$store.state.userInfo.userPhone : '';
  var token = this.$store.state.userInfo.token ? this.$store.state.userInfo.token : '';
  // let lang=''
  // if (store.state.langType=='en') lang='en'
  // if (store.state.langType=='cn')	lang='zh'
  // if (store.state.langType=='tw')	lang='tw'
  // console.log(token)
  _index.default.commit('setLoading', true);
  return new Promise(function (res, rej) {
    uni.request({
      ...
      success: function success(data) {
        // console.log(data)
        _index.default.commit('setLoading', false);
        if (data.statusCode == 200) {
          ...
          {
            _index.default.dispatch('warn', data.data.message);
      ...
      fail: function fail() {
        _index.default.commit('setLoading', false);
        _index.default.dispatch('warn', '网络异常');
      } });
...
/***/ 87:
/*!*************************************************!*\
  !*** F:/HDemo/BM/components/uni-popup/popup.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _message = _interopRequireDefault(__webpack_require__(/*! ./message.js */ 88));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 88:
/*!***************************************************!*\
  !*** F:/HDemo/BM/components/uni-popup/message.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
